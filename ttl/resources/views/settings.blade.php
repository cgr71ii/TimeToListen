            ...
            <div class="col-xl-9 mx-auto">
                <div class="cta-inner text-center rounded">
                    <h2 class="section-heading mb-4">
                        <span class="section-heading-lower">{{ session('user')->name }} {{ session('user')->lastname }}</span>
                    </h2>
                    <hr>
                    <div id="user-info-wrapper">
                        <div id="user-info-img">
                            @if (File::exists(session('user')->pic_profile_path))
                            <img width="300" heigth"300" src="{{ session('user')->pic_profile_path }}" alt="User Image">
                            @else
                            ...
                            <div id="user-info-content-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-md-10 offset-md-1">
                                        ...
                                        <p><img width="32" heigth"32" src="favicon.png"> {{ session('user')->song_status->name }} <img width="32" heigth"32" src="favicon.png"></p>
                                        @if (session('user')->song_status !== null && File::exists(session('user')->song_status->song_path))
                                        <audio style="width:350px;" controls id="myaudio"><source src="{{ session('user')->song_status->song_path }}" type="audio/wav">Audio not Available!</audio>
